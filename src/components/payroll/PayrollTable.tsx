          ...
          <tbody className="divide-y divide-slate-100">
            {items.map((item) => {
              ...
              const alreadySent = Boolean(
                item.payroll &&
                  (item.payroll.status === "SENT" || item.payroll.status === "DOWNLOADED"),
              );
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-2">
                      ...
                      {item.payroll ? (
                        <>
                          ...
                          <button
                            type="button"
                            disabled={!canSend || isSendLoading || alreadySent}
                            onClick={() => onSend(item)}
                          ...
                          >
                            {alreadySent ? "Already Sent" : isSendLoading ? "Sending..." : "Send Payslip"}
                          </button>
