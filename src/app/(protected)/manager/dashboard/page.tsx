...
import { BirthdayNotificationsPanel } from "@/components/crm/BirthdayNotificationsPanel";
  ...
  return (
    <AuthGate allowIf={canManageTeam}>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 auto-rows-min">
        ...
        <BirthdayNotificationsPanel
          users={birthdayUsersQuery.data ?? []}
          loading={birthdayUsersQuery.isLoading}
